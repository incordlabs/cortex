...
`examples/guide/` [directory](https://github.com/qora-protocol/cortex/tree/main/examples/guide).
...
`B::FloatElem`). While importing the `cortex::tensor::ElementConversion` trait, you can call `.elem()`
