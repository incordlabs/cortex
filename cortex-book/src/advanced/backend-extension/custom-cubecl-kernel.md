...
[examples directory](https://github.com/qora-protocol/cortex/tree/main/examples/custom-cubecl-kernel).
...
pub trait AutodiffBackend: Backend + cortex::tensor::backend::AutodiffBackend {}
```

In our project, we can use these traits instead of the
`cortex::tensor::backend::{Backend, AutodiffBackend}` traits provided by Cortex. Cortex's user APIs
...
[`cubecl` Book](https://github.com/qora-protocol/cubecl/tree/f5b63076a01a5c03ea9ed20799d3eeaf776b45da/cubecl-book).
