...
[cortex-onnx examples](https://github.com/qora-protocol/cortex-onnx/tree/main/examples/raspberry-pi-pico).
...
cortex = { version = "0.21", default-features = false, features = ["ndarray"] } # Backend must be ndarray
cortex-store = { version = "0.21", default-features = false, features = ["burnpack"] }
...
```rs
use cortex::{backend::NdArray, tensor::Tensor};

type Backend = NdArray<f32>;
type BackendDevice = <Backend as cortex::tensor::backend::Backend>::Device;
```
