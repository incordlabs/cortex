...
[example](https://github.com/qora-protocol/cortex/tree/main/examples/custom-training-loop) for you to
test.
...
of a model. In Cortex, each `GradientParams` can contain only a subset of gradients to actually apply with an optimizer.
