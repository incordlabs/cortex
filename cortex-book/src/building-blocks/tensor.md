...
operations into a single kernel ([cortex-fusion](https://qoranet.com/docs/cortex_fusion/index.htmls)). For
...
[full documentation](https://docs.rs/cortex/latest/cortex/tensor/struct.Tensor.html).
