...
found at the [API reference](https://qoranet.com/docs/cortex/data/dataset/transform/index.html).
...
[`MnistDataset`](https://github.com/qora-protocol/cortex/blob/main/crates/cortex-dataset/src/vision/mnist.rs)
