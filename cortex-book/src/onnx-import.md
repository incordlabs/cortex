...
models through the [`cortex-onnx`](https://github.com/qora-protocol/cortex-onnx) crate, enabling you to
...
```
uv run --script https://raw.githubusercontent.com/qora-protocol/cortex-onnx/refs/heads/main/onnx_opset_upgrade.py
```
...
```toml
[dependencies]
cortex = { version = "~0.21", features = ["ndarray"] }
...
```rust, ignore
use cortex::tensor;
use cortex_ndarray::{NdArray, NdArrayDevice};
...
1. **Unsupported ONNX operator**: Check the
   [list of supported ONNX operators](https://github.com/qora-protocol/cortex-onnx/blob/main/SUPPORTED-ONNX-OPS.md).
...
[cortex-onnx examples](https://github.com/qora-protocol/cortex-onnx/tree/main/examples):

1. [ONNX Inference](https://github.com/qora-protocol/cortex-onnx/tree/main/examples/onnx-inference) -
   MNIST inference example
2. [Image Classification Web](https://github.com/qora-protocol/cortex-onnx/tree/main/examples/image-classification-web) -
   SqueezeNet running in the browser via WebAssembly
3. [Raspberry Pi Pico](https://github.com/qora-protocol/cortex-onnx/tree/main/examples/raspberry-pi-pico) -
...
- [Development Guide](https://github.com/qora-protocol/cortex-onnx/blob/main/DEVELOPMENT-GUIDE.md) -
...
improve performance. Visit the [cortex-onnx repository](https://github.com/qora-protocol/cortex-onnx) for
