...
[primitive types](https://github.com/qora-protocol/cortex/blob/main/crates/cortex-core/src/module/param/primitive.rs).
...
Record may become incompatible with previous versions of Cortex, depending on the chosen format. The
