...
[blog post](https://qoranet.com/blog/cortex-rusty-approach-to-tensor-handling).
...
- `base` => All tensor kinds should implement these operations (reshape, into_data, etc.). The
  ...
  [crates/cortex-tensor/src/tensor/api/base.rs](https://github.com/qora-protocol/cortex/blob/6d96e8d8086d2309c425f2c8a43a8246f8c454d2/crates/cortex-tensor/src/tensor/api/base.rs).
- `numeric` => All tensors that are numeric by nature should implement these operations (Add, Sub,
  Div, etc.). The implementation is in
  [crates/cortex-tensor/src/tensor/api/numeric.rs](https://github.com/qora-protocol/cortex/blob/6d96e8d8086d2309c425f2c8a43a8246f8c454d2/crates/cortex-tensor/src/tensor/api/numeric.rs).
- `Float` => Tensor operations are only available for float tensors. The implementation is in
  [cortex-tensor/src/tensor/api/float.rs](https://github.com/qora-protocol/cortex/blob/6d96e8d8086d2309c425f2c8a43a8246f8c454d2/crates/cortex-tensor/src/tensor/api/float.rs).
- `Int` => Tensor operations are only available for int tensors. The implementation is in
  [cortex-tensor/src/tensor/api/int.rs](https://github.com/qora-protocol/cortex/blob/6d96e8d8086d2309c425f2c8a43a8246f8c454d2/crates/cortex-tensor/src/tensor/api/int.rs).
- `bool` => Tensor operations are only available for bool tensors. The implementation is in
  [cortex-tensor/src/tensor/api/bool.rs](https://github.com/qora-protocol/cortex/blob/6d96e8d8086d2309c425f2c8a43a8246f8c454d2/crates/cortex-tensor/src/tensor/api/bool.rs).
...
is in
[crates/cortex-tensor/src/tensor/ops/module.rs](https://github.com/qora-protocol/cortex/tree/6d96e8d8086d2309c425f2c8a43a8246f8c454d2/crates/cortex-tensor/src/tensor/ops/modules).
`activation` => These should also be exported as functions instead of methods on tensors. The
implementation is in
[crates/cortex-tensor/src/tensor/ops/activation.rs](https://github.com/qora-protocol/cortex/blob/6d96e8d8086d2309c425f2c8a43a8246f8c454d2/crates/cortex-tensor/src/tensor/ops/activation.rs).
