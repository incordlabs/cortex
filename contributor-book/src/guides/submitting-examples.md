...
For a minimal working example, see the [simple-regression](https://github.com/qora-protocol/cortex/blob/main/examples/simple-regression/examples/regression.rs) example in the repository.
