...
[![Live Demo](https://img.shields.io/badge/live-demo-brightgreen)](https://qoranet.com/demo)
...
The inference components of `cortex` with the `ndarray` backend can be built with `#![no_std]`. This
