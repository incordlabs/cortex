...
#[cfg(feature = "ddp")]
use cortex::collective::{AllReduceStrategy, CollectiveConfig};
...
pub fn train<B: AutodiffBackend, D: TextClassificationDataset + 'static>(
    ...
    let training = SupervisedTraining::new(artifact_dir, dataloader_train, dataloader_test)
        ...
        .summary()
        .with_training_strategy(cortex::train::TrainingStrategy::MultiDevice(
            devices,
    ...
    let training = SupervisedTraining::new(artifact_dir, dataloader_train, dataloader_test)
        ...
        .metric_train_numeric(LearningRateMetric::new())
        .with_file_checkpointer(CompactRecorder::new())
        .with_training_strategy(cortex::train::ddp(devices, collective_config))
        .num_epochs(config.num_epochs)
        .summary();
