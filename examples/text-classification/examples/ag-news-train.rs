...
mod tch_gpu {
    use crate::{ElemType, launch};
    use cortex::backend::autodiff::checkpoint::strategy::BalancedCheckpointing;
    use cortex::backend::{
        Autodiff,
...
mod vulkan {
    use crate::{ElemType, launch};
    use cortex::backend::{Autodiff, Vulkan, autodiff::checkpoint::strategy::BalancedCheckpointing};
...
mod metal {
    use crate::{ElemType, launch};
    use cortex::backend::{Autodiff, Metal};
...
mod cuda {
    ...
    use cortex::backend::{Autodiff, Cuda, autodiff::checkpoint::strategy::BalancedCheckpointing};
...
mod rocm {
    use crate::{ElemType, launch};
    use cortex::backend::{Autodiff, Rocm, autodiff::checkpoint::strategy::BalancedCheckpointing};
