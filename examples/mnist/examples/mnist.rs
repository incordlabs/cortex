...
use cortex::{Dispatch, DispatchDevice};
use mnist::training;

#[cfg(feature = "cuda")]
use cortex::backend::cuda::CudaDevice;
#[cfg(feature = "tch-gpu")]
use cortex::backend::libtorch::LibTorchDevice;
#[cfg(feature = "ndarray")]
use cortex::backend::ndarray::NdArrayDevice;
#[cfg(feature = "rocm")]
use cortex::backend::rocm::RocmDevice;
#[cfg(any(feature = "wgpu", feature = "metal", feature = "vulkan"))]
use cortex::backend::wgpu::WgpuDevice;
