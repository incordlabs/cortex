...
use cortex::module::{Content, DisplaySettings, Initializer, Module, ModuleDisplay, Param};
...
impl<B: Backend> PRelu<B> {
    ...
    /// - output: `[..., any]`
    ///
    /// See also [prelu](cortex::tensor::activation::prelu) for more information.
    pub fn forward<const D: usize>(&self, input: Tensor<B, D>) -> Tensor<B, D> {
        cortex::tensor::activation::prelu(input, self.alpha.val())
    }
}
