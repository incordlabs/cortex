...
use cortex::tensor::activation::log_sigmoid;
use cortex::tensor::{Int, Tensor, backend::Backend};
use cortex::{config::Config, module::Module};
...
impl<B: Backend> BinaryCrossEntropyLoss<B> {
    ...
    pub fn forward<const D: usize>(
        ...
        let mut loss = if self.logits {
            ...
            // https://github.com/qora-protocol/cortex/issues/2739: clamp at -100.0 to avoid undefined values
...
mod tests {
    ...
    use cortex::tensor::{TensorData, activation::sigmoid};
