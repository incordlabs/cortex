...
use cortex::module::{Ignored, Module};
use cortex::tensor::Tensor;
use cortex::tensor::backend::Backend;
use cortex::tensor::ops::PadMode;

use cortex::tensor::module::max_pool2d;
...
impl MaxPool2d {
    ...
    ///
    /// See [max_pool2d](cortex::tensor::module::max_pool2d) for more information.
    ///
    /// # Shapes
    ///
    ...
    pub fn forward<B: Backend>(&self, input: Tensor<B, 4>) -> Tensor<B, 4> {
        ...
        // See: https://github.com/qora-protocol/cortex/issues/4362
        // Handle asymmetric padding by applying explicit pad operation first
        if top != bottom || left != right {
            // Cortex's pad takes (left, right, top, bottom) for the last two dimensions
