use alloc::format;
use cortex::tensor::ops::DeformConvOptions;
...
use cortex::tensor::module::deform_conv2d;
...
impl<B: Backend> DeformConv2d<B> {
    ...
    ///
    /// See [deform_conv2d](cortex::tensor::module::deform_conv2d) for more information.
    ///
    /// # Shapes
    ///
