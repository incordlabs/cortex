...
use cortex::module::{Content, DisplaySettings, Ignored, Module, ModuleDisplay, Param};
use cortex::tensor::Tensor;
use cortex::tensor::backend::Backend;
use cortex::tensor::module::conv2d;
use cortex::tensor::ops::PaddedConvOptions;
...
impl<B: Backend> Conv2d<B> {
    ...
    ///
    /// See [conv2d](cortex::tensor::module::conv2d) for more information.
    ///
    /// # Shapes
    ...
    /// # Example
    /// ```rust,ignore
    /// use cortex::nn::conv::Conv2dConfig;
    /// use cortex::tensor::Tensor;
    ///
