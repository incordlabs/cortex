...
use cortex::tensor::{Tensor, backend::Backend, module::conv1d, ops::PaddedConvOptions};
use cortex::{
    config::Config,
...
impl<B: Backend> Conv1d<B> {
    ...
    ///
    /// See [conv1d](cortex::tensor::module::conv1d) for more information.
    ///
    /// # Shapes
    ///
...
#[cfg(test)]
mod tests {
    use cortex::tensor::{ElementConversion, ops::FloatElem};
