...
use cortex::tensor::module::conv_transpose2d;
...
impl<B: Backend> ConvTranspose2d<B> {
    ...
    ///
    /// See also [conv_transpose2d](cortex::tensor::module::conv_transpose2d).
    ///
    /// # Shapes
    ///
...
mod tests {
    ...
    use cortex::tensor::{ElementConversion, Tolerance, ops::FloatElem};
