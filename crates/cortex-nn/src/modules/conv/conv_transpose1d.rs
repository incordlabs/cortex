...
use cortex::module::Content;
use cortex::module::DisplaySettings;
use cortex::module::Initializer;
use cortex::module::Module;
use cortex::module::ModuleDisplay;
use cortex::module::Param;
use cortex::tensor::Tensor;
use cortex::tensor::backend::Backend;
use cortex::tensor::module::conv_transpose1d;
use cortex::tensor::ops::ConvTransposeOptions;
...
impl<B: Backend> ConvTranspose1d<B> {
    ...
    ///
    /// See also [conv_transpose1d](cortex::tensor::module::conv_transpose1d).
    ///
    /// # Shapes
    ///
...
mod tests {
    ...
    use cortex::tensor::{ElementConversion, Tolerance};
