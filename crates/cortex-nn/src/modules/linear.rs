...
use cortex::tensor::module::linear;
...
mod tests {
    ...
    use cortex::module::ParamId;
    use cortex::record::{BinBytesRecorder, FullPrecisionSettings, Recorder};
    use cortex::tensor::ElementConversion;
    use cortex::tensor::{Shape, TensorData};
    ...
    fn col_row_same_result() {
        ...
        let signal = Tensor::<_, 2>::random([8, 6], cortex::tensor::Distribution::Default, &device);
