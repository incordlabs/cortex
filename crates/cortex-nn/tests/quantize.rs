...
use cortex::module::{Module, Quantizer};
use cortex::tensor::{
...
pub type B = cortex_ndarray::NdArray<f32>;

#[cfg(all(test, feature = "test-wgpu"))]
/// Backend for test cases
pub type B = cortex_wgpu::Wgpu;

#[cfg(all(test, feature = "test-cuda"))]
/// Backend for test cases
pub type B = cortex_cuda::Cuda;

#[cfg(all(test, feature = "test-rocm"))]
/// Backend for test cases
pub type B = cortex_rocm::Rocm;
