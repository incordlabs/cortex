...
use cortex_nn::{Initializer, LinearConfig};
...
#[derive(Module, Debug)]
struct ForwardTestModel<B: cortex_tensor::backend::Backend> {
    linear1: cortex_nn::Linear<B>,
    linear2: cortex_nn::Linear<B>,
}

impl<B: cortex_tensor::backend::Backend> ForwardTestModel<B> {
...
impl ForwardTestModelConfig {
    fn init<B: cortex_tensor::backend::Backend>(&self, device: &B::Device) -> ForwardTestModel<B> {
        ForwardTestModel {
