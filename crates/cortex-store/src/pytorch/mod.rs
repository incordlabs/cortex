//! PyTorch format support for cortex-store.
//!
//! This module provides comprehensive support for loading PyTorch model files (.pth, .pt)
//! into Cortex, with automatic weight transformation and flexible configuration options.
//!
//! ## Features
//!
//! - **Direct .pth/.pt file loading**: Load PyTorch checkpoint and state dict files
//! - **Automatic weight transformation**: `PyTorchToCortexAdapter` is applied by default:
...
//!
//! // Load a PyTorch model (PyTorchToCortexAdapter is applied automatically)
