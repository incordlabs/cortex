...
use alloc::vec::Vec;
use cortex_core::record::serde::{adapter::DefaultAdapter, data::NestedValue, de::Deserializer};
...
pub enum PytorchError {
    ...
    Serde(cortex_core::record::serde::error::Error),
}
...
impl From<cortex_core::record::serde::error::Error> for PytorchError {
    fn from(e: cortex_core::record::serde::error::Error) -> Self {
...
/// # Example
/// ```rust,no_run
/// # use cortex_store::pytorch::PytorchReader;
