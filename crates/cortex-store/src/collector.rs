...
use cortex_core::module::{ModuleVisitor, Param, ParamId};
...
/// ```rust,no_run
/// # use cortex_store::{Collector, PathFilter};
...
mod tests {
    ...
    fn root_level_parameters() {
        use cortex_core::module::ModuleVisitor;
