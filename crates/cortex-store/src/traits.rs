...
///
/// This trait provides convenient methods to collect and apply tensor snapshots from any Cortex module.
...
pub trait ModuleSnapshot<B: Backend>: Module<B> {
        ...
        Self: Sized,
    {
        ...
        // See https://github.com/qora-protocol/cortex/issues/3754
        unsafe {
