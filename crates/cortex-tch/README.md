# Cortex Torch Backend

[Cortex](https://github.com/qora-protocol/cortex) Torch backend

[![Current Crates.io Version](https://img.shields.io/crates/v/cortex-tch.svg)](https://crates.io/crates/cortex-tch)
[![license](https://shields.io/badge/license-MIT%2FApache--2.0-blue)](https://github.com/qora-protocol/cortex-tch/blob/master/README.md)

This crate provides a Torch backend for [Cortex](https://github.com/qora-protocol/cortex) utilizing the
...
before building `cortex-tch` or a crate which depends on it.
...
PowerShell commands below before building `cortex-tch` or a crate which depends on it.
...
[Cortex mnist example](https://github.com/qora-protocol/cortex/tree/main/examples/mnist).
