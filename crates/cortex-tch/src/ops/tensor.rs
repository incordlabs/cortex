...
use cortex_backend::tensor::{BoolTensor, FloatTensor, IntTensor};
use cortex_backend::{
    DType, Distribution, FloatDType, Shape, TensorData, TensorMetadata, ops::FloatTensorOps,
};
use cortex_backend::{Scalar, bf16, f16};
...
impl<E: TchElement> FloatTensorOps<Self> for LibTorch<E> {
    ...
    fn float_slice(tensor: TchTensor, slices: &[cortex_backend::Slice]) -> TchTensor {
