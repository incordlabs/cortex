use super::*;
use cortex_tensor::Distribution;
use cortex_tensor::Tolerance;
use cortex_tensor::module::attention;
use cortex_tensor::module::attention_fallback;
use cortex_tensor::ops::AttentionModuleOptions;

#[test]
fn test_attention_no_mask() {
    // Skip on metal with f16 - flash attention returns zeros
    // Enable once this issue is fixed: https://github.com/qora-protocol/cortex/issues/4325
    #[cfg(feature = "metal")]
    if core::any::TypeId::of::<FloatElemType>() == core::any::TypeId::of::<cortex_tensor::f16>() {
        return;
    }
