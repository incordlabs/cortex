...
use cortex_tensor::{Distribution, Tensor, module};
...
fn conv2d_should_match_reference_backend() {
    ...
    let options = cortex_tensor::ops::ConvOptions::new([2, 3], [2, 3], [2, 3], 2);
...
fn conv2d_should_match_reference_backend_implicit() {
    ...
    let options = cortex_tensor::ops::ConvOptions::new([1, 1], [2, 2], [1, 1], 1);
...
fn conv2d_should_match_reference_backend_bias_regression() {
    ...
    let options = cortex_tensor::ops::ConvOptions::new([1, 1], [1, 1], [1, 1], 1);
