// Cortex autodiff tests, reusable with element types.
...
mod checkpointing {
    pub use super::*;
    use cortex_autodiff::checkpoint::strategy::BalancedCheckpointing;
...
use cortex_backend_tests::test_float_elem_variant;
