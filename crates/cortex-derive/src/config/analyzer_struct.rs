...
impl ConfigStructAnalyzer {
    ...
    fn gen_serialize_fn(
        ...
        quote! {
            impl cortex::serde::Serialize for #name {

                fn serialize<S>(&self, serializer: S) -> Result<S::Ok, S::Error>
                where
                    S: cortex::serde::Serializer {
                    #[derive(cortex::serde::Serialize)]
    ...
    fn gen_deserialize_fn(
        ...
        quote! {
            impl<'de> cortex::serde::Deserialize<'de> for #name {
                fn deserialize<D>(deserializer: D) -> Result<Self, D::Error>
                where
                    D: cortex::serde::Deserializer<'de> {
                    #[derive(cortex::serde::Deserialize)]
                    #[serde(crate = "cortex::serde")]
                    #struct_gen
...
impl ConfigAnalyzer for ConfigStructAnalyzer {
        ...
        quote! {
            impl core::fmt::Display for #name {
                fn fmt(&self, f: &mut core::fmt::Formatter<'_>) -> core::fmt::Result {
                    f.write_str(&cortex::config::config_to_json(self))
                }
            }
        }
    }
    ...
    fn gen_config_impl(&self) -> TokenStream {
        ...
        quote! {
            impl cortex::config::Config for #name {
            }
        }
    }
}
