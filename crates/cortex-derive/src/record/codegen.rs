...
impl<G: RecordItemCodegen> RecordCodegen<G> {
    ...
    pub(crate) fn gen_record_type(&self) -> TokenStream {
        ...
        let param: syn::Generics = parse_quote! { <S: cortex::record::PrecisionSettings >};
    ...
    pub(crate) fn gen_impl_record(&self) -> TokenStream {
        ...
        quote! {
            impl #impl_generics cortex::record::Record<B> for #name #ty_generics #where_clause {
                type Item<S: cortex::record::PrecisionSettings> = #name_item #ty_generics_item;
