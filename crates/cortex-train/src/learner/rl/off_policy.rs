...
use cortex_core::{self as cortex};
use cortex_core::{config::Config, data::dataloader::Progress};
use cortex_ndarray::NdArray;
use cortex_rl::{AsyncPolicy, Policy, PolicyLearner, SliceAccess, TransitionBuffer};
    ...
    RLC::PolicyAction: SliceAccess<RLC::Backend>,
{
    fn train_loop(
        ...
        let device: <RLC::Backend as cortex_core::prelude::Backend>::Device = Default::default();
