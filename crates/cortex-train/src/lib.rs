...
//! A library for training neural networks using the cortex crate.
...
#[cfg(test)]
pub(crate) type TestBackend = cortex_ndarray::NdArray<f32>;

#[cfg(test)]
pub(crate) mod tests {
    use crate::TestBackend;
    use cortex_core::{prelude::Tensor, tensor::Bool};
