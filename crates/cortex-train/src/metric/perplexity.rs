...
use cortex_core::tensor::backend::Backend;
use cortex_core::tensor::{ElementConversion, Int, Tensor};
...
impl<B: Backend> Metric for PerplexityMetric<B> {
    ...
    fn update(
        ...
        let log_probs = cortex_core::tensor::activation::log_softmax(outputs, 1);
