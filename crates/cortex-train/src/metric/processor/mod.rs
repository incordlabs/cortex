...
pub(crate) mod test_utils {
    ...
    use cortex_core::tensor::{ElementConversion, Tensor, backend::Backend};
    ...
    pub(crate) fn process_train(
        ...
        let dummy_progress = cortex_core::data::dataloader::Progress {
            items_processed: 1,
            items_total: 10,
        };
        let dummy_global_progress = cortex_core::data::dataloader::Progress {
