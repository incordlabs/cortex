...
///
/// ```ignore
/// use cortex_train::metric::vision::{LpipsConfig, LpipsNet};
///
/// // VGG (default)
...
///
/// ```ignore
/// use cortex_train::metric::vision::{LpipsConfig, LpipsNet, Reduction};
///
...
mod tests {
    use super::*;
    use cortex_core::tensor::{TensorData, Tolerance, ops::FloatElem};
