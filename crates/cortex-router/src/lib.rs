...
/// It transfers tensors between backends via the underlying [tensor data](cortex_backend::TensorData).
...
mod tests {
    ...
    pub type TestBackend1 = cortex_ndarray::NdArray<f32, i32>;
    pub type TestBackend2 = cortex_wgpu::Wgpu<f32, i32>;
