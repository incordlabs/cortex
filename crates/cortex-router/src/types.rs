...
use cortex_ir::{BackendIr, OperationIr, TensorHandle, TensorId, TensorIr};
...
macro_rules! impl_multi_backend_types {
    ...
    ($module_name:ident, $DefaultBackend:ident, $($OtherBackend:ident),+) => {
        ...
        /// - `ByteBridge`: a simple multi-backend bridge that transfers tensors via the underlying [tensor data](cortex_backend::TensorData).
        ///
        ...
        pub mod $module_name {
            ...
            impl<$DefaultBackend: Backend, $($OtherBackend: Backend),+> cortex_std::device::Device for MultiDevice<$DefaultBackend, $($OtherBackend),+> {
