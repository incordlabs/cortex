use cortex_core::{self as cortex, Tensor};

use cortex_core::module::ParamId;
use cortex_core::prelude::{Backend, DeviceOps};
use cortex_core::tensor::Device;
use cortex_core::tensor::backend::DeviceId;

use super::GradientsParams;
use crate::LearningRate;
use alloc::vec::Vec;
use cortex::module::AutodiffModule;
use cortex::record::Record;
use cortex::tensor::backend::AutodiffBackend;
