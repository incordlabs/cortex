...
pub use cortex_derive::Module;
use cortex_tensor::{Bool, Int, Tensor, ops::Device};
...
///
/// Modules should be created using the [derive](cortex_derive::Module) attribute.
...
/// parameter B. This will be used by the [derive](cortex_derive::Module) attribute to generate the code
/// necessary to optimize and train the module on any backend.
///
/// ```rust, ignore
/// // Not necessary when using the cortex crate directly.
