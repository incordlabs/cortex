...
/// A trait that defines the adapter for a Cortex module.
///
/// This is used to adapt an incoming module to a Cortex module.
pub trait CortexModuleAdapter: Sized {
    /// Adapts a module.
...
impl CortexModuleAdapter for DefaultAdapter {}
