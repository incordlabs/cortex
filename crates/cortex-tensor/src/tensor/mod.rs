...
/// The backend module.
pub mod backend {
    pub use cortex_backend::backend::*;
}

/// The container module.
pub mod container {
    pub use cortex_backend::tensor::TensorContainer;
}
...
pub mod ops {
    pub use cortex_backend::backend::ops::*;
    pub use cortex_backend::tensor::{
...
pub use ops::Device; // Re-export device so that it's available from `cortex_tensor::Device`.
