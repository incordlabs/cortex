...
use cortex_backend::tensor::quantization::QuantizationParametersPrimitive;
use core::f32;
...
"#
    ...
    /// ```rust
    /// use cortex_tensor::backend::Backend;
    /// use cortex_tensor::{Tensor, Bool, Shape};
    ///
    /// fn example<B: Backend>() {
    ///    let device = B::Device::default();
    ...
    ///
    /// ```ignore
    /// use cortex_tensor::ops::{GridSampleOptions, GridSamplePaddingMode, InterpolateMode};
    ///
