...
use cortex_backend::{Backend, Device, DeviceId, DeviceOps};
use cortex_std::stub::RwLock;
use cortex_std::{DType, FloatDType, IntDType};
...
/// use cortex_tensor::{DType, Int, Tensor, set_default_dtypes};
///
...
/// ```rust
/// use cortex_tensor::backend::Backend;
/// use cortex_tensor::{DType, Tensor, set_default_float_dtype};
///
/// fn example<B: Backend>() {
///     let device = B::Device::default();
///     
...
/// ```rust
/// use cortex_tensor::backend::Backend;
/// use cortex_tensor::{DType, Int, Tensor, set_default_int_dtype};
///
/// fn example<B: Backend>() {
///     let device = B::Device::default();
///     
