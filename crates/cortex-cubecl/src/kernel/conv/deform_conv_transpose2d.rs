...
use cortex_backend::{DType, Shape, TensorMetadata, ops::DeformConvOptions};
use cubecl::{
...
fn backward_gradient_inputs<R: CubeRuntime>(
    ...
    for group in 0..groups {
        ...
        columns = slice_assign(
            columns,
            &[
                cortex_backend::Slice::from(group..group + 1),
                cortex_backend::Slice::from(0..col_shape_0),
                cortex_backend::Slice::from(0..col_shape_1),
            ],
            values,
        );
    }
