use cortex_backend::{DType, Shape, TensorMetadata as _, quantization::QParamTensor};
use cortex_std::{Metadata, Strides};
...
/// tensor handle.
pub type QParams = cortex_backend::quantization::QParams<QParamTensor>;
