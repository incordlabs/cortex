...
impl<H: Clone> HandleContainer<H> {
    ...
    /// Get the [float tensor](cortex_backend::backend::Backend::FloatTensorPrimitive) corresponding to the
    ...
    /// Get the [int tensor](cortex_backend::backend::Backend::IntTensorPrimitive) corresponding to the
    /// given [tensor intermediate representation](TensorIr).
    ...
    /// Get the [bool tensor](cortex_backend::backend::Backend::BoolTensorPrimitive) corresponding to the
    /// given [tensor intermediate representation](TensorIr).
    ...
    /// Get the [quantized tensor](cortex_backend::backend::Backend::QuantizedTensorPrimitive) corresponding to the
    /// given [tensor intermediate representation](TensorIr).
    ...
    /// Register a new [float tensor](cortex_backend::backend::Backend::FloatTensorPrimitive) with the corresponding [tensor id](TensorId).
    ...
    /// Register a new [quantized tensor](cortex_backend::backend::Backend::QuantizedTensorPrimitive) with the corresponding [tensor ids](TensorId).
    ...
    /// Register a new [int tensor](cortex_backend::backend::Backend::IntTensorPrimitive) with the corresponding [tensor id](TensorId).
    ...
    /// Register a new [bool tensor](cortex_backend::backend::Backend::BoolTensorPrimitive) with the corresponding [tensor id](TensorId).
