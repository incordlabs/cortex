use cortex_backend::ops::AttentionModuleOptions;
use cortex_backend::tensor::IndexingUpdateOp;
use core::hash::Hash;
...
pub enum FloatOperationIr {
    /// Operation corresponding to [exp](cortex_backend::ops::FloatTensorOps::float_exp).
    Exp(UnaryOpIr),
    /// Operation corresponding to [log](cortex_backend::ops::FloatTensorOps::float_log).
    Log(UnaryOpIr),
    /// Operation corresponding to [log1p](cortex_backend::ops::FloatTensorOps::float_log1p).
    Log1p(UnaryOpIr),
    /// Operation corresponding to [erf](cortex_backend::ops::FloatTensorOps::float_erf).
    Erf(UnaryOpIr),
    /// Operation corresponding to [powf_scalar](cortex_backend::ops::FloatTensorOps::float_powf_scalar).
    PowfScalar(ScalarOpIr),
    /// Operation corresponding to [sqrt](cortex_backend::ops::FloatTensorOps::float_sqrt).
    Sqrt(UnaryOpIr),
    /// Operation corresponding to [cos](cortex_backend::ops::FloatTensorOps::float_cos).
    Cos(UnaryOpIr),
    /// Operation corresponding to [cosh](cortex_backend::ops::FloatTensorOps::float_cosh).
    Cosh(UnaryOpIr),
    /// Operation corresponding to [sin](cortex_backend::ops::FloatTensorOps::float_sin).
    Sin(UnaryOpIr),
    /// Operation corresponding to [sin](cortex_backend::ops::FloatTensorOps::float_sinh).
    Sinh(UnaryOpIr),
    /// Operation corresponding to [tan](cortex_backend::ops::FloatTensorOps::float_tan).
    Tan(UnaryOpIr),
    /// Operation corresponding to [tanh](cortex_backend::ops::FloatTensorOps::float_tanh).
    Tanh(UnaryOpIr),
    /// Operation corresponding to [acos](cortex_backend::ops::FloatTensorOps::float_acos).
    ArcCos(UnaryOpIr),
    /// Operation corresponding to [acosh](cortex_backend::ops::FloatTensorOps::float_acosh).
    ArcCosh(UnaryOpIr),
    /// Operation corresponding to [asin](cortex_backend::ops::FloatTensorOps::float_asin).
    ArcSin(UnaryOpIr),
    /// Operation corresponding to [asinh](cortex_backend::ops::FloatTensorOps::float_asinh).
    ArcSinh(UnaryOpIr),
    /// Operation corresponding to [atan](cortex_backend::ops::FloatTensorOps::float_atan).
    ArcTan(UnaryOpIr),
    /// Operation corresponding to [atanh](cortex_backend::ops::FloatTensorOps::float_atanh).
    ArcTanh(UnaryOpIr),
    /// Operation corresponding to [atan2](cortex_backend::ops::FloatTensorOps::float_atan2).
    ArcTan2(BinaryOpIr),
    /// Operation corresponding to [round](cortex_backend::ops::FloatTensorOps::float_round).
    Round(UnaryOpIr),
    /// Operation corresponding to [floor](cortex_backend::ops::FloatTensorOps::float_floor).
    Floor(UnaryOpIr),
    /// Operation corresponding to [ceil](cortex_backend::ops::FloatTensorOps::float_ceil).
    Ceil(UnaryOpIr),
    /// Operation corresponding to [trunc](cortex_backend::ops::FloatTensorOps::float_trunc).
    Trunc(UnaryOpIr),
    /// Operation corresponding to [into_int](cortex_backend::ops::FloatTensorOps::float_into_int).
    IntoInt(CastOpIr),
    /// Operation corresponding to [matmul](cortex_backend::ops::FloatTensorOps::float_matmul).
    Matmul(MatmulOpIr),
    /// Operation corresponding to [cross](cortex_backend::ops::FloatTensorOps::float_cross).
    Cross(CrossOpIr),
    /// Operation corresponding to [random](cortex_backend::ops::FloatTensorOps::float_random).
    Random(RandomOpIr),
    /// Operation corresponding to [recip](cortex_backend::ops::FloatTensorOps::float_recip).
    Recip(UnaryOpIr),
    /// Operation corresponding to [is_nan](cortex_backend::ops::FloatTensorOps::float_is_nan).
    IsNan(UnaryOpIr),
    /// Operation corresponding to [is_nan](cortex_backend::ops::FloatTensorOps::float_is_inf).
    IsInf(UnaryOpIr),
    /// Operation corresponding to [quantize](cortex_backend::ops::QTensorOps::quantize).
    Quantize(QuantizeOpIr),
    /// Operation corresponding to [dequantize](cortex_backend::ops::QTensorOps::dequantize).
    Dequantize(DequantizeOpIr),
    /// Operation corresponding to [grid_sample_2d](cortex_backend::ops::FloatTensorOps::float_grid_sample_2d).
...
pub enum ModuleOperationIr {
    /// Operation corresponding to [embedding](cortex_backend::ops::ModuleOps::embedding).
    Embedding(EmbeddingOpIr),
    /// Operation corresponding to [embedding_backward](cortex_backend::ops::ModuleOps::embedding_backward).
    EmbeddingBackward(EmbeddingBackwardOpIr),
    /// Operation corresponding to [conv1d](cortex_backend::ops::ModuleOps::conv1d).
    Conv1d(Conv1dOpIr),
    /// Operation corresponding to [conv1d_x_backward](cortex_backend::ops::ModuleOps::conv1d_x_backward).
    Conv1dXBackward(Conv1dXBackwardOpIr),
    /// Operation corresponding to [conv1d_weight_backward](cortex_backend::ops::ModuleOps::conv1d_weight_backward).
    Conv1dWeightBackward(Conv1dWeightBackwardOpIr),
    /// Operation corresponding to [conv1d_bias_backward](cortex_backend::ops::ModuleOps::conv1d_bias_backward).
    Conv1dBiasBackward(Conv1dBiasBackwardOpIr),
    /// Operation corresponding to [conv2d](cortex_backend::ops::ModuleOps::conv2d).
    Conv2d(Conv2dOpIr),
    /// Operation corresponding to [conv2d_x_backward](cortex_backend::ops::ModuleOps::conv2d_x_backward).
    Conv2dXBackward(Conv2dXBackwardOpIr),
    /// Operation corresponding to [conv2d_weight_backward](cortex_backend::ops::ModuleOps::conv2d_weight_backward).
    Conv2dWeightBackward(Conv2dWeightBackwardOpIr),
    /// Operation corresponding to [conv2d_bias_backward](cortex_backend::ops::ModuleOps::conv2d_bias_backward).
    Conv2dBiasBackward(Conv2dBiasBackwardOpIr),
    /// Operation corresponding to [conv3d](cortex_backend::ops::ModuleOps::conv3d).
    Conv3d(Conv3dOpIr),
    /// Operation corresponding to [conv3d_x_backward](cortex_backend::ops::ModuleOps::conv3d_x_backward).
    Conv3dXBackward(Conv3dXBackwardOpIr),
    /// Operation corresponding to [conv3d_weight_backward](cortex_backend::ops::ModuleOps::conv3d_weight_backward).
    Conv3dWeightBackward(Conv3dWeightBackwardOpIr),
    /// Operation corresponding to [conv3d_bias_backward](cortex_backend::ops::ModuleOps::conv3d_bias_backward).
    Conv3dBiasBackward(Conv3dBiasBackwardOpIr),
    /// Operation corresponding to [deform_conv2d](cortex_backend::ops::ModuleOps::deform_conv2d)
    DeformableConv2d(Box<DeformConv2dOpIr>),
    /// Operation corresponding to [deform_conv2d_backward](cortex_backend::ops::ModuleOps::deform_conv2d_backward)
    DeformableConv2dBackward(Box<DeformConv2dBackwardOpIr>),
    /// Operation corresponding to [conv transpose 1d](cortex_backend::ops::ModuleOps::conv_transpose1d).
    ConvTranspose1d(ConvTranspose1dOpIr),
    /// Operation corresponding to [conv transpose 2d](cortex_backend::ops::ModuleOps::conv_transpose2d).
    ConvTranspose2d(ConvTranspose2dOpIr),
    /// Operation corresponding to [conv transpose 3d](cortex_backend::ops::ModuleOps::conv_transpose3d).
    ConvTranspose3d(ConvTranspose3dOpIr),
    /// Operation corresponding to [avg pool 1d](cortex_backend::ops::ModuleOps::avg_pool1d).
    AvgPool1d(AvgPool1dOpIr),
    /// Operation corresponding to [avg pool 2d](cortex_backend::ops::ModuleOps::avg_pool2d).
    AvgPool2d(AvgPool2dOpIr),
    /// Operation corresponding to
    /// [avg pool 1d backward](cortex_backend::ops::ModuleOps::avg_pool1d_backward).
    AvgPool1dBackward(AvgPool1dBackwardOpIr),
    /// Operation corresponding to
    /// [avg pool 2d backward](cortex_backend::ops::ModuleOps::avg_pool2d_backward).
    AvgPool2dBackward(AvgPool2dBackwardOpIr),
    /// Operation corresponding to
    /// [adaptive avg pool 1d](cortex_backend::ops::ModuleOps::adaptive_avg_pool1d).
    AdaptiveAvgPool1d(AdaptiveAvgPool1dOpIr),
    /// Operation corresponding to
    /// [adaptive avg pool 2d](cortex_backend::ops::ModuleOps::adaptive_avg_pool2d).
    AdaptiveAvgPool2d(AdaptiveAvgPool2dOpIr),
    /// Operation corresponding to
    /// [adaptive avg pool 1d backward](cortex_backend::ops::ModuleOps::adaptive_avg_pool1d_backward).
    AdaptiveAvgPool1dBackward(AdaptiveAvgPool1dBackwardOpIr),
    /// Operation corresponding to
    /// [adaptive avg pool 2d backward](cortex_backend::ops::ModuleOps::adaptive_avg_pool2d_backward).
    AdaptiveAvgPool2dBackward(AdaptiveAvgPool2dBackwardOpIr),
    /// Operation corresponding to
    /// [max pool 1d](cortex_backend::ops::ModuleOps::max_pool1d).
    MaxPool1d(MaxPool1dOpIr),
    /// Operation corresponding to
    /// [max pool 1d with indices](cortex_backend::ops::ModuleOps::max_pool1d_with_indices).
    MaxPool1dWithIndices(MaxPool1dWithIndicesOpIr),
    /// Operation corresponding to
    /// [max pool 1d with indices backward](cortex_backend::ops::ModuleOps::max_pool1d_with_indices_backward).
    MaxPool1dWithIndicesBackward(MaxPool1dWithIndicesBackwardOpIr),
    /// Operation corresponding to
    /// [max pool 2d](cortex_backend::ops::ModuleOps::max_pool1d).
    MaxPool2d(MaxPool2dOpIr),
    /// Operation corresponding to
    /// [max pool 2d with indices](cortex_backend::ops::ModuleOps::max_pool2d_with_indices).
    MaxPool2dWithIndices(MaxPool2dWithIndicesOpIr),
    /// Operation corresponding to
    /// [max pool 2d with indices backward](cortex_backend::ops::ModuleOps::max_pool2d_with_indices_backward).
    MaxPool2dWithIndicesBackward(MaxPool2dWithIndicesBackwardOpIr),
    /// Operation corresponding to [interpolate](cortex_backend::ops::ModuleOps::interpolate).
    Interpolate(InterpolateOpIr),
    /// Operation corresponding to [interpolate backward](cortex_backend::ops::ModuleOps::interpolate_backward).
    InterpolateBackward(InterpolateBackwardOpIr),
    /// Operation corresponding to [attention](cortex_backend::ops::ModuleOps::attention).
...
pub enum BaseOperationIr {
    /// Operation corresponding to:
    ///
    /// Float => [reshape](cortex_backend::ops::FloatTensorOps::float_reshape).
    /// Int => [reshape](cortex_backend::ops::IntTensorOps::int_reshape).
    /// Bool => [reshape](cortex_backend::ops::BoolTensorOps::bool_reshape).
    Reshape(ShapeOpIr),

    /// Operation corresponding to:
    ///
    /// Float => [swap_dims](cortex_backend::ops::FloatTensorOps::float_swap_dims).
    /// Int => [swap_dims](cortex_backend::ops::IntTensorOps::int_swap_dims).
    /// Bool => [swap_dims](cortex_backend::ops::BoolTensorOps::bool_swap_dims).
    SwapDims(SwapDimsOpIr),

    /// Operation corresponding to:
    ///
    /// Float => [permute](cortex_backend::ops::FloatTensorOps::float_permute).
    /// Int => [permute](cortex_backend::ops::IntTensorOps::int_permute).
    /// Bool => [permute](cortex_backend::ops::BoolTensorOps::bool_permute).
    Permute(PermuteOpIr),

    /// Operation corresponding to:
    /// Float => [flip](cortex_backend::ops::FloatTensorOps::float_flip).
    /// Int => [flip](cortex_backend::ops::IntTensorOps::int_flip).
    /// Bool => [flip](cortex_backend::ops::BoolTensorOps::bool_flip).
    Flip(FlipOpIr),

    /// Operation corresponding to:
    ///
    /// Float => [expand](cortex_backend::ops::FloatTensorOps::float_expand).
    /// Int => [expand](cortex_backend::ops::IntTensorOps::int_expand).
    /// Bool => [expand](cortex_backend::ops::BoolTensorOps::bool_expand).
    Expand(ShapeOpIr),
    ...
    /// Operation corresponding to:
    ///
    /// Float => [slice](cortex_backend::ops::FloatTensorOps::float_slice).
    /// Int => [slice](cortex_backend::ops::IntTensorOps::int_slice).
    /// Bool => [slice](cortex_backend::ops::BoolTensorOps::bool_slice).
    Slice(SliceOpIr),
    /// Operation corresponding to:
    ///
    /// Float => [slice assign](cortex_backend::ops::FloatTensorOps::float_slice_assign).
    /// Int => [slice assign](cortex_backend::ops::IntTensorOps::int_slice_assign).
    /// Bool => [slice assign](cortex_backend::ops::BoolTensorOps::bool_slice_assign).
    SliceAssign(SliceAssignOpIr),
    /// Operation corresponding to:
    ///
    /// Float => [select](cortex_backend::ops::FloatTensorOps::float_select).
    /// Int => [select](cortex_backend::ops::IntTensorOps::int_select).
    /// Bool => [select](cortex_backend::ops::BoolTensorOps::bool_select).
    Select(SelectOpIr),
    /// Operation corresponding to:
    ///
    /// Float => [select assign](cortex_backend::ops::FloatTensorOps::float_select_add).
    /// Int => [select assign](cortex_backend::ops::IntTensorOps::int_select_add).
    /// Bool => [select assign](cortex_backend::ops::BoolTensorOps::bool_select_or).
    SelectAssign(SelectAssignOpIr),
    /// Operation corresponding to:
    ///
    /// Float => [mask where](cortex_backend::ops::FloatTensorOps::float_mask_where).
    /// Int => [mask where](cortex_backend::ops::IntTensorOps::int_mask_where).
    /// Bool => [mask where](cortex_backend::ops::BoolTensorOps::bool_mask_where).
    MaskWhere(MaskWhereOpIr),
    /// Operation corresponding to:
    ///
    /// Float => [mask fill](cortex_backend::ops::FloatTensorOps::float_mask_fill).
    /// Int => [mask fill](cortex_backend::ops::IntTensorOps::int_mask_fill).
    /// Bool => [mask fill](cortex_backend::ops::BoolTensorOps::bool_mask_fill).
    MaskFill(MaskFillOpIr),
    /// Operation corresponding to:
    ///
    /// Float => [gather](cortex_backend::ops::FloatTensorOps::float_gather).
    /// Int => [gather](cortex_backend::ops::IntTensorOps::int_gather).
    /// Bool => [gather](cortex_backend::ops::BoolTensorOps::bool_gather).
    Gather(GatherOpIr),
    /// Operation corresponding to:
    ///
    /// Float => [scatter](cortex_backend::ops::FloatTensorOps::float_scatter_add).
    /// Int => [scatter](cortex_backend::ops::IntTensorOps::int_scatter_add).
    /// Bool => [scatter](cortex_backend::ops::BoolTensorOps::bool_scatter_or).
    Scatter(ScatterOpIr),
    /// Operation corresponding to:
    ///
    /// Float => [equal](cortex_backend::ops::FloatTensorOps::float_equal).
    /// Int => [equal](cortex_backend::ops::IntTensorOps::int_equal).
    /// Bool => [equal](cortex_backend::ops::BoolTensorOps::bool_equal).
    Equal(BinaryOpIr),
    /// Operation corresponding to:
    ///
    /// Float => [equal elem](cortex_backend::ops::FloatTensorOps::float_equal_elem).
    /// Int => [equal elem](cortex_backend::ops::IntTensorOps::int_equal_elem).
    /// Bool => [equal elem](cortex_backend::ops::BoolTensorOps::bool_equal_elem).
    EqualElem(ScalarOpIr),
    /// Operation corresponding to:
    ///
    /// Float => [repeat dim](cortex_backend::ops::FloatTensorOps::float_repeat_dim).
    /// Int => [repeat dim](cortex_backend::ops::IntTensorOps::int_repeat_dim).
    /// Bool => [repeat dim](cortex_backend::ops::BoolTensorOps::bool_repeat_dim).
    RepeatDim(RepeatDimOpIr),
    /// Operation corresponding to:
    ///
    /// Float => [cat](cortex_backend::ops::FloatTensorOps::float_cat).
    /// Int => [cat](cortex_backend::ops::IntTensorOps::int_cat).
    /// Bool => [cat](cortex_backend::ops::BoolTensorOps::bool_cat).
    Cat(CatOpIr),
    /// Cast operation, no direct operation and should be supported by fusion backend.
    Cast(CastOpIr),
    /// Operation corresponding to:
    ///
    /// Float => [empty](cortex_backend::ops::FloatTensorOps::float_empty).
    /// Int => [empty](cortex_backend::ops::IntTensorOps::int_empty).
    /// Bool => [empty](cortex_backend::ops::BoolTensorOps::bool_empty).
    Empty(CreationOpIr),
    /// Operation corresponding to:
    ///
    /// Float => [ones](cortex_backend::ops::FloatTensorOps::float_ones).
    /// Int => [ones](cortex_backend::ops::IntTensorOps::int_ones).
    /// Bool => [ones](cortex_backend::ops::BoolTensorOps::bool_ones).
    Ones(CreationOpIr),
    /// Operation corresponding to:
    ///
    /// Float => [zeros](cortex_backend::ops::FloatTensorOps::float_zeros).
    /// Int => [zeros](cortex_backend::ops::IntTensorOps::int_zeros).
    /// Bool => [zeros](cortex_backend::ops::BoolTensorOps::bool_zeros).
    Zeros(CreationOpIr),
}
...
pub enum NumericOperationIr {
    /// Operation corresponding to:
    ///
    /// Float => [add](cortex_backend::ops::FloatTensorOps::float_add).
    /// Int => [add](cortex_backend::ops::IntTensorOps::int_add).
    Add(BinaryOpIr),
    /// Operation corresponding to:
    ///
    /// Float => [add scalar](cortex_backend::ops::FloatTensorOps::float_add_scalar).
    /// Int => [add scalar](cortex_backend::ops::IntTensorOps::int_add_scalar).
    AddScalar(ScalarOpIr),
    /// Operation corresponding to:
    ///
    /// Float => [sub](cortex_backend::ops::FloatTensorOps::float_sub).
    /// Int => [sub](cortex_backend::ops::IntTensorOps::int_sub).
    Sub(BinaryOpIr),
    /// Operation corresponding to:
    ///
    /// Float => [sub scalar](cortex_backend::ops::FloatTensorOps::float_sub_scalar).
    /// Int => [sub scalar](cortex_backend::ops::IntTensorOps::int_sub_scalar).
    SubScalar(ScalarOpIr),
    /// Operation corresponding to:
    ///
    /// Float => [div](cortex_backend::ops::FloatTensorOps::float_div).
    /// Int => [div](cortex_backend::ops::IntTensorOps::int_div).
    Div(BinaryOpIr),
    /// Operation corresponding to:
    ///
    /// Float => [div scalar](cortex_backend::ops::FloatTensorOps::float_div_scalar).
    /// Int => [div scalar](cortex_backend::ops::IntTensorOps::int_div_scalar).
    DivScalar(ScalarOpIr),
    /// Operation corresponding to:
    ///
    /// Float => [rem](cortex_backend::ops::FloatTensorOps::float_remainder).
    /// Int => [rem](cortex_backend::ops::IntTensorOps::int_remainder).
    Rem(BinaryOpIr),
    /// Operation corresponding to:
    ///
    /// Float => [rem scalar](cortex_backend::ops::FloatTensorOps::float_remainder_scalar).
    /// Int => [rem scalar](cortex_backend::ops::IntTensorOps::int_remainder_scalar).
    RemScalar(ScalarOpIr),
    /// Operation corresponding to:
    ///
    /// Float => [mul](cortex_backend::ops::FloatTensorOps::float_mul).
    /// Int => [mul](cortex_backend::ops::IntTensorOps::int_mul).
    Mul(BinaryOpIr),
    /// Operation corresponding to:
    ///
    /// Float => [mul scalar](cortex_backend::ops::FloatTensorOps::float_mul_scalar).
    /// Int => [mul scalar](cortex_backend::ops::IntTensorOps::int_mul_scalar).
    MulScalar(ScalarOpIr),
    /// Operation corresponding to:
    ///
    /// Float => [abs](cortex_backend::ops::FloatTensorOps::float_abs).
    /// Int => [abs](cortex_backend::ops::IntTensorOps::int_abs).
    Abs(UnaryOpIr),
    /// Operation corresponding to:
    ///
    /// Float => [full](cortex_backend::ops::FloatTensorOps::float_full).
    /// Int => [full](cortex_backend::ops::IntTensorOps::int_full).
    Full(FullOpIr),
    /// Operation corresponding to:
    ///
    /// Float => [mean dim](cortex_backend::ops::FloatTensorOps::float_mean_dim).
    /// Int => [mean dim](cortex_backend::ops::IntTensorOps::int_mean_dim).
    MeanDim(ReduceDimOpIr),
    /// Operation corresponding to:
    ///
    /// Float => [mean](cortex_backend::ops::FloatTensorOps::float_mean).
    /// Int => [mean](cortex_backend::ops::IntTensorOps::int_mean).
    Mean(ReduceOpIr),
    /// Operation corresponding to:
    ///
    /// Float => [sum](cortex_backend::ops::FloatTensorOps::float_sum).
    /// Int => [sum](cortex_backend::ops::IntTensorOps::int_sum).
    Sum(ReduceOpIr),
    /// Operation corresponding to:
    ///
    /// Float => [sum dim](cortex_backend::ops::FloatTensorOps::float_sum_dim).
    /// Int => [sum dim](cortex_backend::ops::IntTensorOps::int_sum_dim).
    SumDim(ReduceDimOpIr),
    /// Operation corresponding to:
    ///
    /// Float => [prod](cortex_backend::ops::FloatTensorOps::float_prod).
    /// Int => [prod](cortex_backend::ops::IntTensorOps::int_prod).
    Prod(ReduceOpIr),
    /// Operation corresponding to:
    ///
    /// Float => [prod dim](cortex_backend::ops::FloatTensorOps::float_prod_dim).
    /// Int => [prod dim](cortex_backend::ops::IntTensorOps::int_prod_dim).
    ProdDim(ReduceDimOpIr),
    /// Operation corresponding to:
    ///
    /// Float => [greater](cortex_backend::ops::FloatTensorOps::float_greater).
    /// Int => [greater](cortex_backend::ops::IntTensorOps::int_greater).
    Greater(BinaryOpIr),
    /// Operation corresponding to:
    ///
    /// Float => [greater elem](cortex_backend::ops::FloatTensorOps::float_greater_elem).
    /// Int => [greater elem](cortex_backend::ops::IntTensorOps::int_greater_elem).
    GreaterElem(ScalarOpIr),
    /// Operation corresponding to:
    ///
    /// Float => [greater equal](cortex_backend::ops::FloatTensorOps::float_greater_elem).
    /// Int => [greater elem](cortex_backend::ops::IntTensorOps::int_greater_elem).
    GreaterEqual(BinaryOpIr),
    /// Operation corresponding to:
    ///
    /// Float => [greater equal elem](cortex_backend::ops::FloatTensorOps::float_greater_equal_elem).
    /// Int => [greater equal elem](cortex_backend::ops::IntTensorOps::int_greater_equal_elem).
    GreaterEqualElem(ScalarOpIr),
    /// Operation corresponding to:
    ///
    /// Float => [lower](cortex_backend::ops::FloatTensorOps::float_lower).
    /// Int => [lower](cortex_backend::ops::IntTensorOps::int_lower).
    Lower(BinaryOpIr),
    /// Operation corresponding to:
    ///
    /// Float => [lower elem](cortex_backend::ops::FloatTensorOps::float_lower_elem).
    /// Int => [lower elem](cortex_backend::ops::IntTensorOps::int_lower_elem).
    LowerElem(ScalarOpIr),
    /// Operation corresponding to:
    ///
    /// Float => [lower equal](cortex_backend::ops::FloatTensorOps::float_lower_equal).
    /// Int => [lower equal](cortex_backend::ops::IntTensorOps::int_lower_equal).
    LowerEqual(BinaryOpIr),
    /// Operation corresponding to:
    ///
    /// Float => [lower equal elem](cortex_backend::ops::FloatTensorOps::float_lower_equal_elem).
    /// Int => [lower equal elem](cortex_backend::ops::IntTensorOps::int_lower_equal_elem).
    LowerEqualElem(ScalarOpIr),
    /// Operation corresponding to:
    ///
    /// Float => [argmax](cortex_backend::ops::FloatTensorOps::float_argmax).
    /// Int => [argmax](cortex_backend::ops::IntTensorOps::int_argmax).
    ArgMax(ReduceDimOpIr),
    /// Operation corresponding to:
    ///
    /// Float => [argmin](cortex_backend::ops::FloatTensorOps::float_argmin).
    /// Int => [argmin](cortex_backend::ops::IntTensorOps::int_argmin).
    ArgMin(ReduceDimOpIr),
    /// Operation corresponding to:
    ///
    /// Float => [max](cortex_backend::ops::FloatTensorOps::float_max).
    /// Int => [max](cortex_backend::ops::IntTensorOps::int_max).
    Max(ReduceOpIr),
    /// Operation corresponding to:
    ///
    /// Float => [max dim with indices](cortex_backend::ops::FloatTensorOps::float_max_dim_with_indices).
    /// Int => [max dim with indices](cortex_backend::ops::IntTensorOps::int_max_dim_with_indices).
    MaxDimWithIndices(ReduceDimWithIndicesOpIr),
    /// Operation corresponding to:
    ///
    /// Float => [min dim with indices](cortex_backend::ops::FloatTensorOps::float_min_dim_with_indices).
    /// Int => [min dim with indices](cortex_backend::ops::IntTensorOps::int_min_dim_with_indices).
    MinDimWithIndices(ReduceDimWithIndicesOpIr),
    /// Operation corresponding to:
    ///
    /// Float => [min](cortex_backend::ops::FloatTensorOps::float_min).
    /// Int => [min](cortex_backend::ops::IntTensorOps::int_min).
    Min(ReduceOpIr),
    /// Operation corresponding to:
    ///
    /// Float => [max dim](cortex_backend::ops::FloatTensorOps::float_max_dim).
    /// Int => [max dim](cortex_backend::ops::IntTensorOps::int_max_dim).
    MaxDim(ReduceDimOpIr),
    /// Operation corresponding to:
    ///
    /// Float => [min dim](cortex_backend::ops::FloatTensorOps::float_min_dim).
    /// Int => [min dim](cortex_backend::ops::IntTensorOps::int_min_dim).
    MinDim(ReduceDimOpIr),
    /// Operation corresponding to:
    ///
    /// Float => [max_abs](cortex_backend::ops::FloatTensorOps::float_max_abs).
    /// Int => [max_abs](cortex_backend::ops::IntTensorOps::int_max_abs).
    MaxAbs(ReduceOpIr),
    /// Operation corresponding to:
    ///
    /// Float => [max_abs dim](cortex_backend::ops::FloatTensorOps::float_max_abs_dim).
    /// Int => [max_abs dim](cortex_backend::ops::IntTensorOps::int_max_abs_dim).
    MaxAbsDim(ReduceDimOpIr),
    /// Operation corresponding to:
    ///
    /// Float => [clamp](cortex_backend::ops::FloatTensorOps::float_clamp).
    /// Int => [clamp](cortex_backend::ops::IntTensorOps::int_clamp).
    Clamp(ClampOpIr),
    /// Operation corresponding to:
    ///
    /// Int => [random](cortex_backend::ops::IntTensorOps::int_random).
    IntRandom(RandomOpIr),
    /// Operation corresponding to:
    ///
    /// Float => [powf](cortex_backend::ops::FloatTensorOps::float_powf).
    /// Int => [powf](cortex_backend::ops::IntTensorOps::int_powf).
    Powf(BinaryOpIr),
    /// Operation corresponding to:
    ///
    /// Float => [cumsum](cortex_backend::ops::FloatTensorOps::float_cumsum).
    /// Int => [cumsum](cortex_backend::ops::IntTensorOps::int_cumsum).
    CumSum(DimOpIr),
    /// Operation corresponding to:
    ///
    /// Float => [cumprod](cortex_backend::ops::FloatTensorOps::float_cumprod).
    /// Int => [cumprod](cortex_backend::ops::IntTensorOps::int_cumprod).
    CumProd(DimOpIr),
    /// Operation corresponding to:
    ///
    /// Float => [cummin](cortex_backend::ops::FloatTensorOps::float_cummin).
    /// Int => [cummin](cortex_backend::ops::IntTensorOps::int_cummin).
    CumMin(DimOpIr),
    /// Operation corresponding to:
    ///
    /// Float => [cummax](cortex_backend::ops::FloatTensorOps::float_cummax).
    /// Int => [cummax](cortex_backend::ops::IntTensorOps::int_cummax).
    CumMax(DimOpIr),
}
...
pub enum IntOperationIr {
    /// Operation corresponding to [into float](cortex_backend::ops::IntTensorOps::int_into_float).
    IntoFloat(CastOpIr),
    /// Operation corresponding to:
    ///
    /// Int => [bitwise and](cortex_backend::ops::IntTensorOps::bitwise_and).
    BitwiseAnd(BinaryOpIr),
    /// Operation corresponding to:
    ///
    /// Int => [bitwise and scalar](cortex_backend::ops::IntTensorOps::bitwise_and_scalar).
    BitwiseAndScalar(ScalarOpIr),
    /// Operation corresponding to:
    ///
    /// Int => [bitwise or](cortex_backend::ops::IntTensorOps::bitwise_or).
    BitwiseOr(BinaryOpIr),
    /// Operation corresponding to:
    ///
    /// Int => [bitwise or scalar](cortex_backend::ops::IntTensorOps::bitwise_or_scalar).
    BitwiseOrScalar(ScalarOpIr),
    /// Operation corresponding to:
    ///
    /// Int => [bitwise xor](cortex_backend::ops::IntTensorOps::bitwise_xor).
    BitwiseXor(BinaryOpIr),
    /// Operation corresponding to:
    ///
    /// Int => [bitwise xor scalar](cortex_backend::ops::IntTensorOps::bitwise_xor_scalar).
    BitwiseXorScalar(ScalarOpIr),
    /// Operation corresponding to:
    ///
    /// Int => [bitwise not](cortex_backend::ops::IntTensorOps::bitwise_not).
    BitwiseNot(UnaryOpIr),
    /// Operation corresponding to:
    ///
    /// Int => [bitwise left shift](cortex_backend::ops::IntTensorOps::bitwise_left_shift).
    BitwiseLeftShift(BinaryOpIr),
    /// Operation corresponding to:
    ///
    /// Int => [bitwise left shift scalar](cortex_backend::ops::IntTensorOps::bitwise_left_shift_scalar).
    BitwiseLeftShiftScalar(ScalarOpIr),
    /// Operation corresponding to:
    ///
    /// Int => [bitwise right shift](cortex_backend::ops::IntTensorOps::bitwise_right_shift).
    BitwiseRightShift(BinaryOpIr),
    /// Operation corresponding to:
    ///
    /// Int => [bitwise right shift scalar](cortex_backend::ops::IntTensorOps::bitwise_right_shift_scalar).
    BitwiseRightShiftScalar(ScalarOpIr),
    /// Operation corresponding to [matmul](cortex_backend::ops::IntTensorOps::int_matmul).
    Matmul(MatmulOpIr),
}
...
pub enum BoolOperationIr {
    /// Operation corresponding to [into float](cortex_backend::ops::BoolTensorOps::bool_into_float).
    IntoFloat(CastOpIr),
    /// Operation corresponding to [into int](cortex_backend::ops::BoolTensorOps::bool_into_int).
    IntoInt(CastOpIr),
    /// Operation corresponding to [not](cortex_backend::ops::BoolTensorOps::bool_not).
    Not(UnaryOpIr),
    /// Operation corresponding to [and](cortex_backend::ops::BoolTensorOps::bool_and).
    And(BinaryOpIr),
    /// Operation corresponding to [or](cortex_backend::ops::BoolTensorOps::bool_or).
    Or(BinaryOpIr),
}
...
pub struct SliceAssignOpIr {
    pub tensor: TensorIr,
    pub ranges: Vec<cortex_backend::Slice>,
    pub value: TensorIr,
    pub out: TensorIr,
}
