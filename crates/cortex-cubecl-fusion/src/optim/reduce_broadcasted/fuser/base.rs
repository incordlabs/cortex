...
use cortex_fusion::{FuserProperties, FuserStatus, OperationFuser};
...
mod tests {
    ...
    fn reduce_broadcast_workflow_1() {
        ...
        fuser.fuse(&OperationIr::NumericFloat(
            DType::F32,
            cortex_ir::NumericOperationIr::SumDim(ReduceDimOpIr {
                input: tensor1,
                out: tensor2_out,
                axis: 1,
            }),
        ...
        fuser.fuse(&OperationIr::NumericFloat(
            DType::F32,
            cortex_ir::NumericOperationIr::Add(BinaryOpIr {
                lhs: tensor2,
                rhs: tensor3,
                out: tensor4_out,
            }),
