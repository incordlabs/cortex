use cortex_fusion::stream::Context;
use cortex_std::{DType, Strides, quantization::QParamTensor, strides};
use cubecl::{
    CubeElement, Runtime,
...
/// tensor handle.
pub type QParams = cortex_std::quantization::QParams<QParamTensor>;
