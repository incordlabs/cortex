use cortex_communication::Protocol;
use cortex_communication::data_service::TensorDataServer;
use cortex_communication::{Address, ProtocolServer, data_service::TensorDataService};
