mod tests {
    ...
    use cortex_tensor::{Shape, Tensor, TensorData, TensorPrimitive, Tolerance, backend::Backend};
    ...
    pub type TestBackend = cortex_cuda::Cuda<f32>;

    #[cfg(feature = "test-wgpu")]
    pub type TestBackend = cortex_wgpu::Wgpu<f32>;
