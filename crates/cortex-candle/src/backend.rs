...
pub(crate) fn get_seeded_rng() -> StdRng {
    ...
    seed.take().unwrap_or_else(cortex_std::rand::get_seeded_rng)
}
...
/// ```no_run
/// use cortex_candle::CandleDevice;
///
...
impl cortex_backend::Device for CandleDevice {
    fn to_id(&self) -> cortex_backend::DeviceId {
        match self {
