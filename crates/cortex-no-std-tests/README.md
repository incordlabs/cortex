The `cortex-no-std-tests` contains integration tests aimed to check `no_std` compatibility of `cortex`, `cortex-core`, `cortex-tensor` and `cortex-ndarray` packages.
