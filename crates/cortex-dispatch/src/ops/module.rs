...
impl ModuleOps<Self> for Dispatch {
    fn conv2d(
        ...
        options: cortex_backend::ops::ConvOptions<2>,
    ) -> FloatTensor<Self> {
        multi_op!(
    ...
    fn deform_conv2d(
        ...
        bias: Option<FloatTensor<Self>>,
        options: cortex_backend::ops::DeformConvOptions<2>,
    ) -> FloatTensor<Self> {
        multi_op!(
    ...
    fn conv3d(
        ...
        weight: FloatTensor<Self>,
        bias: Option<FloatTensor<Self>>,
        options: cortex_backend::ops::ConvOptions<3>,
    ) -> FloatTensor<Self> {
        multi_op!(
            inputs[(x, float), (weight, float)],
            opt_inputs[(bias, float)],
    ...
    fn conv_transpose2d(
        ...
        weight: FloatTensor<Self>,
        bias: Option<FloatTensor<Self>>,
        options: cortex_backend::ops::ConvTransposeOptions<2>,
    ) -> FloatTensor<Self> {
        multi_op!(
            inputs[(x, float), (weight, float)],
            opt_inputs[(bias, float)],
    ...
    fn conv_transpose3d(
        ...
        weight: FloatTensor<Self>,
        bias: Option<FloatTensor<Self>>,
        options: cortex_backend::ops::ConvTransposeOptions<3>,
    ) -> FloatTensor<Self> {
        multi_op!(
            inputs[(x, float), (weight, float)],
            opt_inputs[(bias, float)],
    ...
    fn interpolate(
        x: FloatTensor<Self>,
        output_size: [usize; 2],
        options: cortex_backend::ops::InterpolateOptions,
    ) -> FloatTensor<Self> {
        multi_op!(
            inputs[(x, float)],
            => Float,
    ...
    fn conv1d(
        ...
        weight: FloatTensor<Self>,
        bias: Option<FloatTensor<Self>>,
        options: cortex_backend::ops::ConvOptions<1>,
    ) -> FloatTensor<Self> {
        multi_op!(
            inputs[(x, float), (weight, float)],
            opt_inputs[(bias, float)],
    ...
    fn conv_transpose1d(
        ...
        weight: FloatTensor<Self>,
        bias: Option<FloatTensor<Self>>,
        options: cortex_backend::ops::ConvTransposeOptions<1>,
    ) -> FloatTensor<Self> {
        multi_op!(
            inputs[(x, float), (weight, float)],
            opt_inputs[(bias, float)],
    ...
    fn unfold4d(
        x: FloatTensor<Self>,
        kernel_size: [usize; 2],
        options: cortex_backend::ops::UnfoldOptions,
    ) -> FloatTensor<Self> {
    ...
    fn attention(
        ...
        mask: Option<cortex_backend::tensor::BoolTensor<Self>>,
        attn_bias: Option<FloatTensor<Self>>,
        options: cortex_backend::ops::AttentionModuleOptions,
    ) -> FloatTensor<Self> {
        multi_op!(
