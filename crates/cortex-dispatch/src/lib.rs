...
pub(crate) mod backends {
    ...
    #[cfg(feature = "cpu")]
    pub use cortex_cpu::{Cpu, CpuDevice};
    #[cfg(feature = "cuda")]
    pub use cortex_cuda::{Cuda, CudaDevice};
    #[cfg(feature = "rocm")]
    pub use cortex_rocm::{Rocm, RocmDevice};
    #[cfg(wgpu_metal)]
    ...
    #[cfg(feature = "ndarray")]
    pub use cortex_ndarray::{NdArray, NdArrayDevice};
    #[cfg(feature = "tch")]
    pub use cortex_tch::{LibTorch, LibTorchDevice};
}
