use cortex_backend::{DeviceId, DeviceOps};
...
impl Default for DispatchDevice {
    ...
    fn default() -> Self {
        ...
        #[cfg(wgpu_metal)]
        return Self::Metal(cortex_wgpu::WgpuDevice::default());

        #[cfg(feature = "rocm")]
        return Self::Rocm(RocmDevice::default());

        #[cfg(wgpu_vulkan)]
        return Self::Vulkan(cortex_wgpu::WgpuDevice::default());

        #[cfg(wgpu_webgpu)]
        return Self::WebGpu(cortex_wgpu::WgpuDevice::default());
...
impl cortex_std::device::Device for DispatchDevice {
