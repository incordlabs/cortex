...
use cortex_backend::{ElementConversion, TensorMetadata, tensor::FloatTensor};
use cortex_backend::{
...
// Workspace crates
use cortex_backend::{Shape, TensorData, backend::Backend};
    ...
    NdArrayTensor: From<SharedArray<I>>,
{
    ...
    fn bool_slice(tensor: NdArrayTensor, slices: &[cortex_backend::Slice]) -> NdArrayTensor {
        slice!(tensor, slices)
    }
