...
use cortex_backend::tensor::{FloatTensor, IntTensor};
use cortex_backend::{Distribution, IntDType, Scalar, TensorMetadata};

use cortex_backend::ElementConversion;
...
use cortex_backend::{DType, Shape, TensorData, backend::Backend};
    ...
    NdArrayTensor: From<SharedArray<I>>,
{
    ...
    fn int_slice(tensor: NdArrayTensor, slices: &[cortex_backend::Slice]) -> NdArrayTensor {
        slice!(tensor, slices)
    }
