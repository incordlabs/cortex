// Language
use alloc::vec::Vec;
use cortex_backend::backend::ExecutionError;
use cortex_backend::ops::GridSampleOptions;
use cortex_backend::tensor::FloatTensor;
use cortex_backend::{TensorMetadata, element::cast::ToElement};
...
use cortex_backend::{Distribution, FloatDType, Scalar};
use cortex_backend::{ElementConversion, Shape, TensorData, backend::Backend, ops::FloatTensorOps};
    ...
    NdArrayTensor: From<SharedArray<I>>,
{
    ...
    fn float_slice(tensor: FloatTensor<Self>, slices: &[cortex_backend::Slice]) -> FloatTensor<Self> {
        slice!(tensor, slices)
    }

    fn float_slice_assign(
        tensor: FloatTensor<Self>,
        slices: &[cortex_backend::Slice],
        value: FloatTensor<Self>,
    ) -> FloatTensor<Self> {
        execute_with_float_dtype!((tensor, value), |tensor, value| {
