...
use cortex_backend::quantization::{QuantLevel, QuantMode, QuantScheme, QuantStore, QuantValue};
use cortex_backend::tensor::{BoolTensor, FloatTensor, IntTensor, QuantizedTensor};
use cortex_backend::{Backend, DType, DeviceId, DeviceOps};
use cortex_ir::{BackendIr, HandleKind, TensorHandle};
use cortex_std::stub::Mutex;
...
impl cortex_backend::Device for NdArrayDevice {
    ...
    NdArrayTensor: From<SharedArray<I>>,
{
    ...
    fn dtype_usage(_device: &Self::Device, dtype: DType) -> cortex_backend::DTypeUsageSet {
        match dtype {
            DType::F64
            | DType::F32
            | DType::Flex32
            ...
            | DType::U16
            | DType::U8
            | DType::Bool => cortex_backend::DTypeUsage::general(),
            DType::F16 | DType::BF16 => cortex_backend::DTypeUsageSet::empty(),
            DType::QFloat(scheme) => {
                match scheme {
                    QuantScheme {
                        ...
                        ..
                    } => cortex_backend::DTypeUsage::general(),
                    _scheme => cortex_backend::DTypeUsageSet::empty(),
                }
            }
        }
    }
...
mod tests {
    use super::*;
    use cortex_backend::QTensorPrimitive;
