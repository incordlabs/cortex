use cortex_backend::tensor::Device;
use cortex_communication::{Protocol, data_service::TensorDataService};
use cortex_ir::BackendIr;
use cortex_router::Runner;
use cortex_std::id::StreamId;
