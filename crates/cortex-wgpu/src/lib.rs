...
pub use cortex_cubecl::{
    kernel::{KernelMetadata, into_contiguous},
    kernel_source,
    template::{KernelSource, SourceKernel, SourceTemplate, build_info},
};

pub use cortex_cubecl::{BoolElement, FloatElement, IntElement};
pub use cortex_cubecl::{CubeBackend, tensor::CubeTensor};
...
///     cortex::backend::wgpu::init_setup::<cortex::backend::wgpu::graphics::Vulkan>(
///         &device,
///         Default::default(),
///     );
/// }
...
/// # Notes
///
/// This version of the wgpu backend uses [cortex_fusion] to compile and optimize streams of tensor
...
pub type Wgpu<F = f32, I = i32, B = u32> =
    cortex_fusion::Fusion<CubeBackend<cubecl::wgpu::WgpuRuntime, F, I, B>>;
...
/// # Notes
///
/// This version of the wgpu backend doesn't use [cortex_fusion] to compile and optimize streams of tensor
/// operations.
///
...
mod tests {
    use super::*;
    use cortex_backend::{Backend, DType, QTensorPrimitive};
