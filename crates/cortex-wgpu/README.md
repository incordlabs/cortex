...
[Cortex](https://github.com/qora-protocol/cortex) WGPU backend

[![Current Crates.io Version](https://img.shields.io/crates/v/cortex-wgpu.svg)](https://crates.io/crates/cortex-wgpu)
[![license](https://shields.io/badge/license-MIT%2FApache--2.0-blue)](https://github.com/qora-protocol/cortex-wgpu/blob/master/README.md)

This crate provides a WGPU backend for [Cortex](https://github.com/qora-protocol/cortex) using the
...
mod wgpu {
    ...
    use cortex_wgpu::{Wgpu, WgpuDevice};
    use mnist::training;
